...
- [ ] [`docs/phases-upcoming/SIMULATION_CLASS.md`](../phases-upcoming/SIMULATION_CLASS.md):
...
- [ ] [`docs/phases-upcoming/README.md`](../phases-upcoming/README.md):
...
phases-shipped/); no code changes since `93bb752` (C6 ship). 52
