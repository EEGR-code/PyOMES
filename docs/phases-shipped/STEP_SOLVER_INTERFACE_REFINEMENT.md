...
> [`STEP_SOLVER_REFINEMENT_PLAN.md`](../phases-upcoming/STEP_SOLVER_REFINEMENT_PLAN.md)
> on branch `step-solver-interface-refinement`
> (tag `step-solver-interface-refinement-shipped`) — see
> [`STEP_SOLVER_REFINEMENT_CHECKLIST.md`](../phases-upcoming/STEP_SOLVER_REFINEMENT_CHECKLIST.md)
...
`architecture.md`, `README.md`, this note). `docs/phases-shipped/` and
`docs/phases-obsolete/` deliberately left untouched — frozen historical
...
- [`../design/SOLVER_ARCHITECTURE.md`](../design/SOLVER_ARCHITECTURE.md) — the
  ...
  moving this file to `phases-shipped/`.)
