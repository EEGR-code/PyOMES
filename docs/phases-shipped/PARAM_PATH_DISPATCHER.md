...
[`property-snapshot-phase-agnostic`](../phases-shipped/SNAPSHOT_PHASE_AGNOSTIC.md)
...
- **Completes the audit trilogy with**
  [`../phases-shipped/SNAPSHOT_PHASE_AGNOSTIC.md`](../phases-shipped/SNAPSHOT_PHASE_AGNOSTIC.md)
  and
  [`../phases-shipped/PROPERTY_CALCULATORS_PHASE_AGNOSTIC.md`](../phases-shipped/PROPERTY_CALCULATORS_PHASE_AGNOSTIC.md)
