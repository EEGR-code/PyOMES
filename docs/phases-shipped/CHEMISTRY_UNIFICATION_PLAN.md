...
|---|---|---|---|
| 0 | `reaction-protocol-cleanup` | `reaction-protocol-cleanup-shipped` | Collapse `integration_mode` rate/delta into single rate path. Shipped 2026-05-12. See [`phases-shipped/REACTION_PROTOCOL_CLEANUP_CHECKLIST.md`](../phases-shipped/REACTION_PROTOCOL_CLEANUP_CHECKLIST.md). |
| 0.5 | `bsm2-reference-test` | `bsm2-reference-test-shipped` | Golden-trajectory regression test for BSM2 reference model + `SpeciationPropertySolver` forward-note docstring. Shipped 2026-05-12. See [`phases-shipped/BSM2_REFERENCE_TEST.md`](../phases-shipped/BSM2_REFERENCE_TEST.md). |
...
- **Deduplicate `ionic_strength_from_speciation`'s two counting paths.**
  ...
  [`docs/phases-shipped/CHEMISTRY_UNIFICATION_2_CHECKLIST.md`](../phases-shipped/CHEMISTRY_UNIFICATION_2_CHECKLIST.md)
...
- **When Phase 0 ships:** ✅ Done. `reaction-protocol-cleanup` and
  ...
  [`phases-shipped/`](../phases-shipped/) with status banners.
...
- **When Phase 4 ships:** ✅ Done 2026-05-16. Tags
  ...
  plan move to [`phases-shipped/`](../phases-shipped/) now that all
