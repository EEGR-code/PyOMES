...
in [../phases-upcoming/CHEMISTRY_UNIFICATION.md](../phases-upcoming/CHEMISTRY_UNIFICATION.md)
under "Phase F" and the "Equilibrium-Kinetic Coupling and
Accuracy Monitoring" section. The branch slicing is in
[../phases-upcoming/CHEMISTRY_UNIFICATION_PLAN.md](../phases-upcoming/CHEMISTRY_UNIFICATION_PLAN.md)
...
- [ ] [`docs/phases-upcoming/CHEMISTRY_UNIFICATION.md`](../phases-upcoming/CHEMISTRY_UNIFICATION.md)
...
- [ ] [`docs/phases-upcoming/CHEMISTRY_UNIFICATION_PLAN.md`](../phases-upcoming/CHEMISTRY_UNIFICATION_PLAN.md)
      ...
      `phases-shipped/` only if Phase 3b is no longer pending
      (it is trigger-gated, so likely keep them in
      `phases-upcoming/` with the chemistry-unification-1/2/3/4
      shipping banners).
- [ ] [`docs/phases-upcoming/README.md`](../phases-upcoming/README.md) — mark
...
- [ ] Move this checklist to
      [`../phases-shipped/CHEMISTRY_UNIFICATION_4_CHECKLIST.md`](../phases-shipped/)
...
- [ ] Ship via the convention in [../phases-upcoming/README.md](../phases-upcoming/README.md):
