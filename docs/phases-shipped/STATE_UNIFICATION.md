...
[`DAE_VS_OPERATOR_SPLITTING.md`](../phases-upcoming/DAE_VS_OPERATOR_SPLITTING.md) for
...
10. **Operator splitting stays default.** DAE deferred per
    [`DAE_VS_OPERATOR_SPLITTING.md`](../phases-upcoming/DAE_VS_OPERATOR_SPLITTING.md).
...
- [`SIMULATION_CLASS.md`](../phases-upcoming/SIMULATION_CLASS.md) — following phase
  (decisions 11 and 4 reconciled inline post-ship).
- [`CHEMISTRY_UNIFICATION.md`](../phases-upcoming/CHEMISTRY_UNIFICATION.md) and
  [`CHEMISTRY_UNIFICATION_PLAN.md`](../phases-upcoming/CHEMISTRY_UNIFICATION_PLAN.md) —
