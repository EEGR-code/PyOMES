...
- [x] `SpeciationAfterFeedStepSolver`, a custom `StepSolver` that
      ...
      `docs/shipped/ORDERING.md`) rather than an arbitrary
...
- [x] [`docs/shipped/STEP_SOLVER_INTERFACE_REFINEMENT.md`](../shipped/STEP_SOLVER_INTERFACE_REFINEMENT.md)
      — added a "Shipped" banner; moved from `upcoming/` via
