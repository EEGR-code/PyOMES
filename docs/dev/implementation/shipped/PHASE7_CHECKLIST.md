...
[../upcoming/README.md](../upcoming/README.md) accurate as soon as
...
- [ ] Update the "Currently in flight" section.  Replace the
      ...
      **[PHASE7_CHECKLIST.md](PHASE7_CHECKLIST.md)** — *In progress —
      ...
      "**None.**" once the docs move to `shipped/` in C5.
...
- [ ] No remaining `GasLiquidVolume` references in the live tree:
      ...
      Grep "GasLiquidVolume" in src/, models/, systems/, tests/
      ```
      Expected: zero hits in the live tree (only `shipped/`
      historical docs and `upcoming/RUN_HISTORY.md`'s
...
- [../upcoming/README.md](../upcoming/README.md) — update in-flight
