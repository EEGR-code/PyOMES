...
> **Depends on:** [EQUILIBRIUM_CONSTRAINT_UNIFICATION.md](../shipped/EQUILIBRIUM_CONSTRAINT_UNIFICATION.md)
...
- Doc closeout: `MASS_EXCHANGE_ARCHITECTURE.md` §10.4 status table updated
  ...
  §18 marked shipped; both phase docs moved to `shipped/`.
...
- [x] Move this file to `docs/shipped/`.
