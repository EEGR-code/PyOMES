...
[branching and tagging convention](../upcoming/README.md#branching-and-tagging-convention) —
...
2. **RK4 inside Lie-Trotter is wasted accuracy.** The sequential
   ...
   [docs/shipped/ORDERING_CRITIQUE.md](../shipped/ORDERING_CRITIQUE.md)
...
- Changing the operator-split ordering (feed → reactions →
  transfer). That's
  [docs/shipped/ORDERING.md](../shipped/ORDERING.md)
