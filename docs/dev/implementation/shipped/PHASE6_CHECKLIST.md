...
> [GLV_REMOVAL.md](../upcoming/GLV_REMOVAL.md); the larger
...
[CONTAINER_LAYERING.md](../upcoming/CONTAINER_LAYERING.md) factoring.
...
phase ([GLV_REMOVAL.md](../upcoming/GLV_REMOVAL.md)) can delete cleanly.
...
- **System-wide simultaneous integration across multiple CVs.** The
  ...
  capability is the deferred [CONTAINER_LAYERING.md](../upcoming/CONTAINER_LAYERING.md)
...
- **Removal of `GasLiquidVolume`.** The class is reduced to a thin
  ...
  in [GLV_REMOVAL.md](../upcoming/GLV_REMOVAL.md).
...
- [x] Update planning notes /
      [../shipped/](../shipped/) docs only if they
...
- [x] Final grep:
      ...
      `shipped/` historical docs and any `legacy/` content).
...
- [x] Move [SOLVER_PROMOTION.md](SOLVER_PROMOTION.md) and this
      checklist to [../shipped/](../shipped/) with
      "Status: Shipped" banners.
- [x] Update [README.md](../upcoming/README.md) priority list (drop
...
5. **`GasLiquidVolume` removal.** Phase 6 reduces GLV to a
   ...
   every caller. See [GLV_REMOVAL.md](../upcoming/GLV_REMOVAL.md).
