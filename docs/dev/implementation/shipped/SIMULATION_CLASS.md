...
> [`STATE_UNIFICATION`](../shipped/STATE_UNIFICATION.md)
...
- [RUN_HISTORY.md](RUN_HISTORY.md) — the pluggable `Recorder` shape
  ...
  the result schema."
- [STATE_UNIFICATION.md](../shipped/STATE_UNIFICATION.md)
...
**Type-surface note (added with [MULTICV_STEP_SOLVER.md](../upcoming/MULTICV_STEP_SOLVER.md)):**
