...
[../phases-shipped/](../phases-shipped/) once shipped.
...
- `simulation-class` (2026-05-27) — third and final of the three
  ...
  [../phases-shipped/SIMULATION_CLASS.md](../phases-shipped/SIMULATION_CLASS.md)
  and
  [../phases-shipped/SIMULATION_CLASS_CHECKLIST.md](../phases-shipped/SIMULATION_CLASS_CHECKLIST.md).
...
- `state-unification` (2026-05-22) — second of the three
  ...
  3.303580). See
  [../phases-shipped/STATE_UNIFICATION.md](../phases-shipped/STATE_UNIFICATION.md)
  and
  [../phases-shipped/STATE_UNIFICATION_CHECKLIST.md](../phases-shipped/STATE_UNIFICATION_CHECKLIST.md).
...
- `integrator-removal` (2026-05-20) — deleted the `Integrator`
  ...
  [../phases-shipped/INTEGRATOR_REMOVAL.md](../phases-shipped/INTEGRATOR_REMOVAL.md)
  and
  [../phases-shipped/INTEGRATOR_REMOVAL_CHECKLIST.md](../phases-shipped/INTEGRATOR_REMOVAL_CHECKLIST.md).
...
- `reaction-protocol-cleanup` (2026-05-12) — see
  [../phases-shipped/REACTION_PROTOCOL_CLEANUP_CHECKLIST.md](../phases-shipped/REACTION_PROTOCOL_CLEANUP_CHECKLIST.md).
- `bsm2-reference-test` (2026-05-12) — golden-trajectory regression
  ...
  [../phases-shipped/BSM2_REFERENCE_TEST.md](../phases-shipped/BSM2_REFERENCE_TEST.md).
- `chemistry-unification-1` (2026-05-13) — declared equilibrium
  ...
  [../phases-shipped/CHEMISTRY_UNIFICATION_1_CHECKLIST.md](../phases-shipped/CHEMISTRY_UNIFICATION_1_CHECKLIST.md).
- `chemistry-unification-2` (2026-05-15) — `PropertyResult.alphas`
  ...
  closed. See
  [../phases-shipped/CHEMISTRY_UNIFICATION_2_CHECKLIST.md](../phases-shipped/CHEMISTRY_UNIFICATION_2_CHECKLIST.md).
- `chemistry-unification-3` (2026-05-15) — canonical-name dedup in
  ...
  [../phases-shipped/CHEMISTRY_UNIFICATION_3_CHECKLIST.md](../phases-shipped/CHEMISTRY_UNIFICATION_3_CHECKLIST.md).
...
- `chemistry-unification-3b` (2026-06-03) — `ChemistryDatabase` rollout,
  ...
  [../phases-shipped/CHEMISTRY_UNIFICATION_3B_CHECKLIST.md](../phases-shipped/CHEMISTRY_UNIFICATION_3B_CHECKLIST.md).
...
- `partition-model` (2026-06-16) — `PartitionModel` protocol +
  ...
  [../phases-shipped/PARTITION_MODEL.md](../phases-shipped/PARTITION_MODEL.md).
...
1. **[../phases-shipped/CHEMISTRY_UNIFICATION.md](../phases-shipped/CHEMISTRY_UNIFICATION.md)** (design)
   + **[../phases-shipped/CHEMISTRY_UNIFICATION_PLAN.md](../phases-shipped/CHEMISTRY_UNIFICATION_PLAN.md)**
...
2. **[../phases-shipped/RUN_HISTORY.md](../phases-shipped/RUN_HISTORY.md)** —
...
3. **[../phases-shipped/SPECIATION_LEVEL_RETIREMENT.md](../phases-shipped/SPECIATION_LEVEL_RETIREMENT.md)** —
...
4. **[../phases-shipped/CUFERMENTER_SUNSET.md](../phases-shipped/CUFERMENTER_SUNSET.md)** —
...
- **[../phases-shipped/FRAMEWORK_POLISH.md](../phases-shipped/FRAMEWORK_POLISH.md)** —
...
- **[../phases-shipped/PARAM_PATH_DISPATCHER.md](../phases-shipped/PARAM_PATH_DISPATCHER.md)** —
...
- **[../phases-shipped/DEMO_RESTRUCTURE.md](../phases-shipped/DEMO_RESTRUCTURE.md)** —
...
- **[../phases-shipped/RESULT_EXPORT.md](../phases-shipped/RESULT_EXPORT.md)** —
...
- **[../phases-shipped/HPC_CHECKPOINTING.md](../phases-shipped/HPC_CHECKPOINTING.md)** —
...
Phases A–E all shipped 2026-06-11/12; docs moved to `phases-shipped/`.
...
- **[../phases-shipped/CV_COMPUTE_INTERFACE.md](../phases-shipped/CV_COMPUTE_INTERFACE.md)** — Phase A. *Shipped 2026-06-11.*
- **[../phases-shipped/CONTROLLER_STATE_PROTOCOL.md](../phases-shipped/CONTROLLER_STATE_PROTOCOL.md)** — Phase B. *Shipped 2026-06-12.*
- **[../phases-shipped/SYSTEM_SOLVER_PROTOCOL.md](../phases-shipped/SYSTEM_SOLVER_PROTOCOL.md)** — Phase C. *Shipped 2026-06-12.*
- **[../phases-shipped/IMPLICIT_TRANSPORT.md](../phases-shipped/IMPLICIT_TRANSPORT.md)** — Phase D. *Shipped 2026-06-12.*
- **[../phases-shipped/MONOLITHIC_ODE.md](../phases-shipped/MONOLITHIC_ODE.md)** — Phase E. *Shipped 2026-06-12.*
...
- **[LAYER1_GAP_CLOSURE.md](../phases-shipped/LAYER1_GAP_CLOSURE.md)** —
...
2. Write a checklist file (e.g. `PHASE6_CHECKLIST.md`) modelled on
   [../phases-shipped/PHASE5_CHECKLIST.md](../phases-shipped/PHASE5_CHECKLIST.md).
...
6. When the work ships, move both the original note and the
   checklist to [../phases-shipped/](../phases-shipped/), add a
