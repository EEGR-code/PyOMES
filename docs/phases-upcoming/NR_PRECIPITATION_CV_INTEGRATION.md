...
> **Depends on:** [NR_PRECIPITATION_SPECIATION.md](../phases-shipped/NR_PRECIPITATION_SPECIATION.md)
...
| `docs/phases-upcoming/NR_PRECIPITATION_SPECIATION.md` | Add "Shipped" banner |
| `docs/phases-shipped/NR_PRECIPITATION_SPECIATION.md` | Move on ship |
