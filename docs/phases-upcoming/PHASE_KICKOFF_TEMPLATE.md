...
> Copy this file to `docs/phases-upcoming/<PHASE_NAME>_CHECKLIST.md` at the
> start of any phase-shaped work — before writing implementation code. See
> `docs/phases-upcoming/README.md`'s "Branching and tagging convention" for
...
- [ ] Plan/design doc exists in `docs/phases-upcoming/` (or `docs/design/`)
      describing scope
...
- [ ] Move the plan doc + this checklist to `docs/phases-shipped/`, add a
      "Shipped" banner to both
- [ ] Update `docs/phases-upcoming/README.md`'s "Recently shipped" list
