...
- [`../phases-shipped/CV_COMPUTE_INTERFACE.md`](../phases-shipped/CV_COMPUTE_INTERFACE.md) — Phase A
- [`../phases-shipped/CONTROLLER_STATE_PROTOCOL.md`](../phases-shipped/CONTROLLER_STATE_PROTOCOL.md) — Phase B
- [`../phases-shipped/SYSTEM_SOLVER_PROTOCOL.md`](../phases-shipped/SYSTEM_SOLVER_PROTOCOL.md) — Phase C
- [`../phases-shipped/IMPLICIT_TRANSPORT.md`](../phases-shipped/IMPLICIT_TRANSPORT.md) — Phase D
- [`../phases-shipped/MONOLITHIC_ODE.md`](../phases-shipped/MONOLITHIC_ODE.md) — Phase E
