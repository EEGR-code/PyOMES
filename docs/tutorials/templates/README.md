...
```bash
python docs/tutorials/templates/batch_fermenter.py
python docs/tutorials/templates/cstr_fermenter.py
python docs/tutorials/templates/fed_batch_fermenter.py
python docs/tutorials/templates/microplate_fermenter.py
```
