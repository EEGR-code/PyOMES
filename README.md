...
| Aqueous chemical equilibrium / speciation | `test_speciation.py`, `test_speciation_protocols.py`, `test_nr_speciation_engine.py`, `test_equilibrium_classification.py`, `test_activity_dispatch.py` |
