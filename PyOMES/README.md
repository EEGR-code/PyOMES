...
| [`chemistry/`](chemistry/) | `ChemicalRegistry` / compound database, species definitions, and solution recipe builders used to construct feeds and initial conditions. |
...
| [`equilibria/`](equilibria/) | Gas-phase / VLE utilities — equations of state (`IdealGasEOS`, Peng-Robinson) and Henry's-law partitioning. |
